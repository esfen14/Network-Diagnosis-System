...
Revision ID: f1e91f0e3f83
Revises: 
Create Date: 2026-08-20 17:21:52.460579
...
def upgrade_():
    ...
    sa.Column('Status', sa.Enum('RUNNING', 'SUCCESS', 'FAILED', name='deploymentstatus'), nullable=False),
    ...
    sa.Column('Status', sa.Enum('RUNNING', 'SUCCESS', 'FAILED', 'INTERUPPTED', name='discoverystatus'), nullable=False),
    sa.Column('Progress', sa.Integer(), nullable=False),
    sa.Column('Message', sa.String(length=100), nullable=False),
    sa.Column('Start_At', sa.DateTime(), nullable=False),
    sa.Column('Completed_At', sa.DateTime(), nullable=True),
